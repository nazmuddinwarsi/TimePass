	...
	$w1finish.on('click', function( ev ) {
		...
		if ( validated ) {
			new PNotify({
				...
				text: 'You completed the registration form user 1.',
				type: 'custom',
	...
	*/
	...
	$w2finish.on('click', function( ev ) {
		...
		if ( validated ) {
			new PNotify({
				title: 'Congratulations',
				text: 'You completed the registration form user 2.',
				type: 'custom',
				addclass: 'notification-success',
				icon: 'fas fa-check'
			});
	...
	*/
	...
	$w3finish.on('click', function( ev ) {
		...
		if ( validated ) {
			new PNotify({
				title: 'Congratulations',
				text: 'You completed the registration form user3.',
				type: 'custom',
				addclass: 'notification-success',
				icon: 'fas fa-check'
			});
	...
	*/
	...
	$w4finish.on('click', function( ev ) {
		...
		if ( validated ) {
			new PNotify({
				title: 'Congratulations',
				text: 'You completed the registration form user4.',
				type: 'custom',
				addclass: 'notification-success',
				icon: 'fas fa-check'
			});
	...
	*/
	...
	$w5finish.on('click', function( ev ) {
		...
		if ( validated ) {
			new PNotify({
				title: 'Congratulations',
				text: 'You completed the registration form user5.',
				type: 'custom',
				addclass: 'notification-success',
				icon: 'fas fa-check'
			});
